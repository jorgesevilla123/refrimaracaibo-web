...
import { getProducts, test, searchProducts, deleteProduct, updateProduct, addProduct, updatePhoto, calculateTotal, addProductToOrder, getProductsToOrder, updateOrderState } from "../controllers/products-controllers";
const router = Router();
...
router.route('/update-state').post(updateOrderState)
